...
export function FacilityCard({
  ...
  return (
    <div className="group relative h-[280px] sm:h-[300px] md:h-[400px] overflow-hidden rounded-xl glass-panel-strong transition-all duration-500 ease-out md:hover:border-primary/40 md:hover:shadow-[0_12px_48px_-8px_rgba(45,212,191,0.18)]">
      <Image
        alt={title}
